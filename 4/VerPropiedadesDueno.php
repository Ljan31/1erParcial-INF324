<?php 
session_start();
if (!isset($_SESSION['usuario']) || $_SESSION['rol'] !== 'dueño') {
                ...
                <tbody>
                    <?php while ($propiedad = mysqli_fetch_array($resultadoPropiedades)): ?>
                        <tr>
                            ...
                            <td>
                                <?php echo "<a class='btn btn-outline-danger me-2' href='http://localhost:8080/impuesto4/ImpuestoServlet?id={$propiedad['id']}'>Impuesto</a>"; ?>
                            </td>";
                        </tr>
                    <?php endwhile; ?>
                </tbody>
