            ...
            <tbody>
                ...
                while ($fila = mysqli_fetch_array($resultadoCatastro)) {
                    ...
                    if ($fila['ci'] == 0) {
                      ...
                      echo "<td>";
                    //   echo "<a class='btn btn-outline-danger me-2' href='EditarCatastro.php?id={$fila['id']}'>Impuesto</a>";
                      echo "<a class='btn btn-outline-danger me-2' href='http://localhost:8080/impuesto4/ImpuestoServlet?id={$fila['id']}'>Impuesto</a>";
                      echo "</td>";
                    } else {
                        echo "<td>{$fila['ci']}</td>";
                        echo "<td>{$fila['distrito']}</td>";
